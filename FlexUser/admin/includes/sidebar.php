        ...
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Services</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-boletim" ><a href="manage-tiak.php">Clients Tiak</a></li>
                    <li id="menu-academico-boletim" ><a href="manage-taxi.php">Clients Taxi</a></li>
                    <li id="menu-academico-boletim" ><a href="manage-livraison.php">Clients Livraison</a></li>
                </ul>
            </li>
            <li><a href="manage-contact.php"><i class="fa fa-user"></i> <span>Contacts</span></a></li>
