				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Clients Livraison</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Clients Livraison</h3>
						<div class="graph">
							<div class="tables">
...
{               ?>
									     <tr class="active">
									      <th scope="row"><?= htmlentities($row->id);?></th>
									        ...
									        <td><?= htmlentities($row->produits);?></td>
									        <td><?= htmlentities($row->depart);?></td>
									        <td><?= htmlentities($row->livraison);?></td>
									        <td><?= htmlentities($row->heure);?></td>
									        <td><?= htmlentities($row->telephone);?></td>
									        <td><?= htmlentities($row->poids);?></td>
